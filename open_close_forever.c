//vent switches from open and close states given the TEN SEC DELAY forever
//cap on when this behavior stops or initiates isnt set for now
/**
 * -------------------------------------------------
...
#define TEN_SEC_DELAY 500  // 10 seconds = 500 periods (each period is 20ms)
// ---------------------------------------------------------
// =========================================================
